        ...
        <aside className="relative w-full lg:w-[43%] min-h-[560px] lg:min-h-screen flex flex-col justify-between px-6 py-8 md:px-12 lg:px-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex h-10 w-10 items-center justify-center">
              ...
              <span className="absolute inset-0 rounded-full bg-[#0369A1]/20 animate-pulse" />

              <span className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#0369A1] to-[#0C4A6E] text-white shadow-md">
                <Brain size={21} />
              </span>
          ...
          <div className="flex flex-col justify-center flex-1 max-w-xl mx-auto lg:mx-0 py-10 lg:py-0">
            ...
            <div className="inline-flex self-start items-center gap-2 px-4 py-2 mb-6 rounded-full bg-sky-100 text-[#0369A1] text-sm font-medium">
